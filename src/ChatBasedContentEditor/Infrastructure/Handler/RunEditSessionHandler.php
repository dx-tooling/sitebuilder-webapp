...
final readonly class RunEditSessionHandler
{
    ...
    public function __invoke(RunEditSessionMessage $message): void
    {
        ...
        try {
            // Load previous messages from conversation if available
            ...
            foreach ($generator as $chunk) {
                ...
                } elseif ($chunk->chunkType === 'message' && $chunk->message !== null && $conversation !== null) {
    ...
    /**
     * Load previous messages from the conversation, if any.
     *
