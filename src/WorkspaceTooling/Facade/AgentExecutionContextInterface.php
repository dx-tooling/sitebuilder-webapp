...
interface AgentExecutionContextInterface
{
     ...
     * @param list<string>|null $contentAssetsManifestUrls URLs to manifest.json (or similar) for remote content assets
     */
    ...
    /**
     * Get content assets manifest URLs configured for the current project.
     *
     * @return list<string>
     */
