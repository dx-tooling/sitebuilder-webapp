    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE organization_groups (
                ...
                is_default_for_new_members TINYINT(1) NOT NULL,
        ...
        // Create organization_members table (join table)
        $this->addSql(<<<'SQL'
            CREATE TABLE organization_members (
                account_cores_id CHAR(36) NOT NULL,
                organizations_id CHAR(36) NOT NULL,
                INDEX IDX_88725ABC86288A55 (organizations_id),
                PRIMARY KEY (account_cores_id, organizations_id)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`
        SQL);

        // Create organization_group_members table (join table)
        $this->addSql(<<<'SQL'
            CREATE TABLE organization_group_members (
                ...
                PRIMARY KEY (account_cores_id, organization_groups_id)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`
        SQL);
        ...
        $this->addSql(<<<'SQL'
            ...
            ADD CONSTRAINT FK_88725ABC86288A55
            FOREIGN KEY (organizations_id) REFERENCES organizations (id) ON DELETE CASCADE
        SQL);

        $this->addSql(<<<'SQL'
            ALTER TABLE organization_group_members
            ADD CONSTRAINT FK_DED071633700E7C9
            FOREIGN KEY (organization_groups_id) REFERENCES organization_groups (id) ON DELETE CASCADE
        SQL);
        ...
        // Add currently_active_organization_id to account_cores
        $this->addSql(<<<'SQL'
            ALTER TABLE account_cores
            ADD currently_active_organization_id CHAR(36) DEFAULT NULL
        SQL);

        // Add organization_id to projects (nullable first for migration)
        $this->addSql(<<<'SQL'
            ALTER TABLE projects
            ADD organization_id CHAR(36) DEFAULT NULL
        SQL);
    }
